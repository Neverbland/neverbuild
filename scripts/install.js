...
console.log(``);
console.log(`${info} You'll want to add the Gitlab remote: git remote add origin <SSH URL as given on Gitlab>`);
...
console.log(`${info} - ${highlight} (usually Neverbland)`, 'DOCKERCLOUD_NAMESPACE');
console.log(``);
