...
var homepagePathname = process.env.APP_PUBLIC_PATH || '/';
...
if (!process.env.APP_PUBLIC_PATH) {
  ...
  var homepagePath = process.env.APP_HOMEPAGE || require(paths.appPackageJson).homepage;

  homepagePathname = homepagePath
